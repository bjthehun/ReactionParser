...
/**
 * This class provides an empty implementation of {@link DebugInternalReactionsLanguageListener},
 * which can be extended to create a listener which only needs to handle a subset
 * of the available methods.
 */
@SuppressWarnings("CheckReturnValue")
public class DebugInternalReactionsLanguageBaseListener implements DebugInternalReactionsLanguageListener {
	/**
	 * {@inheritDoc}
	 *
